...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.Lightup
{
    ...
    public static partial class ForEachVariableStatementSyntaxExtensions
    {
        ...
        {
            return UpdateFunc1(_obj, attributeLists, awaitKeyword, forEachKeyword, openParenToken, variable, inKeyword, expression, closeParenToken, statement);
        }
