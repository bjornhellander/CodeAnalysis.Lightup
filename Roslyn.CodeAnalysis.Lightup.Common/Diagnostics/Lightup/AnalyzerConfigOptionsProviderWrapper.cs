...
namespace Microsoft.CodeAnalysis.Diagnostics.Lightup
{
    ...
    public readonly struct AnalyzerConfigOptionsProviderWrapper
    {
        ...
        static AnalyzerConfigOptionsProviderWrapper()
        {
            ...
            GetOptionsFunc0 = LightupHelper.CreateInstanceMethodAccessor<GetOptionsDelegate0>(WrappedType, "GetOptions", "SyntaxTree");
            GetOptionsFunc1 = LightupHelper.CreateInstanceMethodAccessor<GetOptionsDelegate1>(WrappedType, "GetOptions", "AdditionalText");
        }
