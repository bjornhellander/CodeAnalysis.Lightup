...
namespace Microsoft.CodeAnalysis.Lightup
{
    ...
    public static class CommandLineArgumentsExtensions
    {
        ...
        static CommandLineArgumentsExtensions()
        {
            ...
            GetOutputFilePathFunc0 = LightupHelper.CreateInstanceMethodAccessor<GetOutputFilePathDelegate0>(wrappedType, "GetOutputFilePath", "String");
            GetPdbFilePathFunc1 = LightupHelper.CreateInstanceMethodAccessor<GetPdbFilePathDelegate1>(wrappedType, "GetPdbFilePath", "String");
        }
