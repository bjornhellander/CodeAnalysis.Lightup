...
namespace Microsoft.CodeAnalysis.Lightup
{
    ...
    public static class SyntaxNodeOrTokenExtensions
    {
        ...
        static SyntaxNodeOrTokenExtensions()
        {
            ...
            IsIncrementallyIdenticalToFunc0 = LightupHelper.CreateInstanceMethodAccessor<IsIncrementallyIdenticalToDelegate0>(wrappedType, "IsIncrementallyIdenticalTo", "SyntaxNodeOrToken");
        }
