...
namespace Microsoft.CodeAnalysis.Lightup
{
    ...
    public static class SyntaxNodeExtensions
    {
        ...
        static SyntaxNodeExtensions()
        {
            ...
            ContainsDirectiveFunc0 = LightupHelper.CreateInstanceMethodAccessor<ContainsDirectiveDelegate0>(wrappedType, "ContainsDirective", "Int32");
            IsIncrementallyIdenticalToFunc1 = LightupHelper.CreateInstanceMethodAccessor<IsIncrementallyIdenticalToDelegate1>(wrappedType, "IsIncrementallyIdenticalTo", "SyntaxNode");
        }
