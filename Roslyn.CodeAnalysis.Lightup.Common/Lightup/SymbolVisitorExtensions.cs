...
namespace Microsoft.CodeAnalysis.Lightup
{
    ...
    public static class SymbolVisitorExtensions
    {
        ...
        static SymbolVisitorExtensions()
        {
            ...
            VisitFunctionPointerTypeFunc0 = LightupHelper.CreateInstanceMethodAccessor<VisitFunctionPointerTypeDelegate0>(wrappedType, "VisitFunctionPointerType", "IFunctionPointerTypeSymbol");
        }
