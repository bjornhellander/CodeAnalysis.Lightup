...
namespace Microsoft.CodeAnalysis.Lightup
{
    ...
    public static class NullableContextExtensionsEx
    {
        ...
        static NullableContextExtensionsEx()
        {
            ...
            AnnotationsEnabledFunc0 = LightupHelper.CreateStaticMethodAccessor<AnnotationsEnabledDelegate0>(wrappedType, nameof(AnnotationsEnabled), true);
            AnnotationsInheritedFunc1 = LightupHelper.CreateStaticMethodAccessor<AnnotationsInheritedDelegate1>(wrappedType, nameof(AnnotationsInherited), true);
            WarningsEnabledFunc2 = LightupHelper.CreateStaticMethodAccessor<WarningsEnabledDelegate2>(wrappedType, nameof(WarningsEnabled), true);
            WarningsInheritedFunc3 = LightupHelper.CreateStaticMethodAccessor<WarningsInheritedDelegate3>(wrappedType, nameof(WarningsInherited), true);
        }
