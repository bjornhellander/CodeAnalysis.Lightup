...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.Lightup
{
    ...
    public static class SwitchStatementSyntaxExtensions
    {
        ...
        static SwitchStatementSyntaxExtensions()
        {
            ...
            UpdateFunc1 = LightupHelper.CreateInstanceMethodAccessor<UpdateDelegate1>(wrappedType, "Update", "SyntaxList`1", "SyntaxToken", "SyntaxToken", "ExpressionSyntax", "SyntaxToken", "SyntaxToken", "SyntaxList`1", "SyntaxToken");
