...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.Lightup
{
    ...
    public static class ForEachStatementSyntaxExtensions
    {
        ...
        static ForEachStatementSyntaxExtensions()
        {
            ...
            UpdateFunc1 = LightupHelper.CreateInstanceMethodAccessor<UpdateDelegate1>(wrappedType, "Update", "SyntaxList`1", "SyntaxToken", "SyntaxToken", "SyntaxToken", "TypeSyntax", "SyntaxToken", "SyntaxToken", "ExpressionSyntax", "SyntaxToken", "StatementSyntax");
