...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.Lightup
{
    ...
    public static class TryStatementSyntaxExtensions
    {
        ...
        static TryStatementSyntaxExtensions()
        {
            ...
            UpdateFunc2 = LightupHelper.CreateInstanceMethodAccessor<UpdateDelegate2>(wrappedType, "Update", "SyntaxList`1", "SyntaxToken", "BlockSyntax", "SyntaxList`1", "FinallyClauseSyntax");
