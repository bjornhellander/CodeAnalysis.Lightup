...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.Lightup
{
    ...
    public static class DoStatementSyntaxExtensions
    {
        ...
        static DoStatementSyntaxExtensions()
        {
            ...
            UpdateFunc1 = LightupHelper.CreateInstanceMethodAccessor<UpdateDelegate1>(wrappedType, "Update", "SyntaxList`1", "SyntaxToken", "StatementSyntax", "SyntaxToken", "SyntaxToken", "ExpressionSyntax", "SyntaxToken", "SyntaxToken");
