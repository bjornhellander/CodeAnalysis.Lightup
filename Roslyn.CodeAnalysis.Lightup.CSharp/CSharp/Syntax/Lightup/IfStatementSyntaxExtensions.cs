...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.Lightup
{
    ...
    public static class IfStatementSyntaxExtensions
    {
        ...
        static IfStatementSyntaxExtensions()
        {
            ...
            UpdateFunc1 = LightupHelper.CreateInstanceMethodAccessor<UpdateDelegate1>(wrappedType, "Update", "SyntaxList`1", "SyntaxToken", "SyntaxToken", "ExpressionSyntax", "SyntaxToken", "StatementSyntax", "ElseClauseSyntax");
