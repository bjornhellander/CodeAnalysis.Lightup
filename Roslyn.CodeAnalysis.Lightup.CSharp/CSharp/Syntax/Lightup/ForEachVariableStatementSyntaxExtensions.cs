...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.Lightup
{
    ...
    public static class ForEachVariableStatementSyntaxExtensions
    {
        ...
        static ForEachVariableStatementSyntaxExtensions()
        {
            ...
            UpdateFunc1 = LightupHelper.CreateInstanceMethodAccessor<UpdateDelegate1>(wrappedType, "Update", "SyntaxList`1", "SyntaxToken", "SyntaxToken", "SyntaxToken", "ExpressionSyntax", "SyntaxToken", "ExpressionSyntax", "SyntaxToken", "StatementSyntax");
