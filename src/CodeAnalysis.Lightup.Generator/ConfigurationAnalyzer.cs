...
public class ConfigurationAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void HandleCompilation(CompilationAnalysisContext context)
    {
        ...
        foreach (var configFile in configFiles)
        {
            ...
            if (!Helpers.TryParseConfiguration(configFileContent, out var assemblies, out var baselineVersion, out var typesToInclude, out var useFoldersInFilePaths, out var useInternalAccessibility, out var errorMessage))
            {
